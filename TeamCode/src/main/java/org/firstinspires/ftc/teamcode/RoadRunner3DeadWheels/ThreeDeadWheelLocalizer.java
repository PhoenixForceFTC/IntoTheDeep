...
import org.firstinspires.ftc.teamcode.RoadRunner3DeadWheels.messages.ThreeDeadWheelInputsMessage;

@Config
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2159.8203170169636; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2030.5051226814467; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =  -1137.793819611698; // x position of the perpendicular encoder (in tick units)
    }
